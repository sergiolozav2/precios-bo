	...
	return (
		<nav className="p-4 absolute top-0 z-10 flex justify-between items-center w-full bg-transparent text-white">
			...
			<div className="relative">
				...
				<div
					className={`${openMenu ? "-md:z-10 -md:min-w-72 -md:absolute -md:right-0 -md:flex -md:flex-col -md:bg-white -md:text-purple-700 -md:px-4 -md:py-4 -md:shadow-lg rounded-md gap-4" : "-md:hidden"} md:flex md:gap-6 md:flex-row items-center`}
				>
					<NavbarLink
